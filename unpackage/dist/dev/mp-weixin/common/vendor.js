...
function populateParameters(result) {var _result$brand =
  ...
  var parameters = {
    appId: "__UNI__034E9A7",
    appName: "多图上传支持拖拽排序【全端支持】示例",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"多图上传支持拖拽排序【全端支持】示例","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
